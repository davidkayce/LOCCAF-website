    ...
    <>
      <div className="events">
        ...
        <div className="events-con">
          <Link className="event event1" to="/starthere">
            ...
            <div className="event-text">
              ...
              <h6>ATLANTA, GA</h6>
              <p className="note">
                Join us in Atlanta, GA on january 3-5, 2024 for Passion 2024. We
                can't wait to gather a generation together to call on Heaven.
      ...
      <div className="pastor-con">
        <div className="pastor">
          ...
          <div className="pastor-contents">
            ...
            <h1>SHELLY</h1>
            <p>
              Louie is a Visionary Architect and Director of the Passion
              Movement, and the founder of Passion Institute. Shelly is the
              chief Strategist , Director of Label Operations and the Artist
              Management of sixstepsrecords, Co-founder of the Passion Movement,
              and leads The GROOVE, a gathering for the girls of Atlanta.
            </p>
            <h3>
